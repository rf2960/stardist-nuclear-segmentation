...
These files are intentionally kept out of normal Git history because they can be tens of MB and contain one row per accepted nucleus. They are the right files to use when downstream analysis needs exact cell locations or segmentation boundaries.
